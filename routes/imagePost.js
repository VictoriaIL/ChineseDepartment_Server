...
const {SECRET_ACCESS_KEY, ACCESS_KEY_ID, REGION, JWT_SECRET, S3_ENDPOINT} = process.env;
        ...
        if (err) {
            ...
            files(req, res, (err) => {
                ...
                req.files.forEach((el) => {
                    locations.push(`https://pub-0b4a2a4d801146cdadeb5c330579352d.r2.dev/${el.key}`);
                });
